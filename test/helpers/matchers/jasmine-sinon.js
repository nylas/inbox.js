(function(jasmine, beforeEach) {
  ...
  function createMatcher(matcher) {
    var original = jasmine.Matchers.prototype[matcher.jasmineName];
  ...
  beforeEach(function() {
    var matchersToAdd = createJasmineSinonMatchers(matchers);
    if (jasmine.Spec && this instanceof jasmine.Spec && this.addMatchers) {
      this.addMatchers(matchersToAdd);
    } else {
      jasmine.addMatchers(matchersToAdd);
    }
  });
