describe('INNamespace', function() {
  ...
  describe('when unsynced', function() {
    it('should have resourceUrl() like <baseUrl>/n/', function() {
      expect ((new INNamespace(inbox)).resourceUrl()).toBe('http://api.inboxapp.co/n/');
    });
  });


  describe('when synced', function() {
    it('should have resourceUrl() like <baseUrl>/n/<id>', function() {
